...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    This function should return a `tuple` with the name of the dish
    as the first item,
...
def compile_ingredients(dishes):
    ...
    This function should return a `set` of all ingredients
    from all listed dishes.
    """
    all_dishes = set()
    for dish in dishes:
...
def separate_appetizers(dishes, appetizers):
    ...
    The function should return the list of dish names
    with appetizer names removed.
...
def singleton_ingredients(dishes, intersection):
    ...
    that only appears once across dishes).
    ...
    The function should return a `set` of ingredients that only appear
    in a single dish.
    """
    singletons = set()
    for dish in dishes:
